...
document.addEventListener('DOMContentLoaded', function () {
  var apiUrl = "https://backend-wheat-eta.vercel.app/api/membros";
  var membroList = document.getElementById('membroList');
  var filterInput = document.getElementById('filter');
  var saveButton = document.getElementById('saveButton');
  var editingMembro = null;

  // Função para editar membro
  function editMembro(id) {
    editingMembro = id;
    fetch("".concat(apiUrl, "/").concat(id)).then(function (response) {
  ...
  function loadMembros() {
    return _loadMembros.apply(this, arguments);
  } // Função para salvar ou editar
  function _loadMembros() {
    _loadMembros = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            return response.json();
          case 6:
            membros = _context2.sent;
            membroList.innerHTML = '';
            membros.forEach(function (membro) {
              var listItem = document.createElement('li');
              listItem.classList.add('list-group-item');
              var button = document.createElement('button');
              listItem.innerHTML = "\n                    <strong>".concat(membro.nome, "</strong><br>\n                    ").concat(membro.numeroRol, " | ").concat(membro.estadoCivil, " | ").concat(membro.situacao, "\n                ");
          ...
          case 11:
            ...
            console.error('Erro ao carregar membros:', _context2.t0);
          case 14:
          case "end":
  ...
  saveButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var nome, dataNascimento, numeroRol, estadoCivil, naturalidade, situacao, membroData, modal;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          nome = document.getElementById('nome').value;
          dataNascimento = document.getElementById('dataNascimento').value;
          numeroRol = document.getElementById('numeroRol').value;
          ...
          _context.next = 11;
          return fetch("".concat(apiUrl, "/").concat(editingMembro), {
            method: 'PUT',
            headers: {
        ...
        case 17:
          loadMembros();
          modal = bootstrap.Modal.getInstance(document.getElementById('cadastroModal'));
          modal.hide();
          _context.next = 25;
          break;
        case 22:
          ...
          console.error('Erro ao salvar membro:', _context.t0);
        case 25:
        case "end":
  ...
  function deleteMembro(_x) {
    return _deleteMembro.apply(this, arguments);
  } // Função para filtrar membros
  function _deleteMembro() {
    _deleteMembro = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            console.error('Erro ao excluir membro:', _context3.t0);
          case 10:
          case "end":
  ...
  filterInput.addEventListener('input', function () {
    ...
    var listItems = membroList.getElementsByTagName('li');
...
},{}],"../../../AppData/Roaming/nvm/v22.1.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../AppData/Roaming/nvm/v22.1.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
